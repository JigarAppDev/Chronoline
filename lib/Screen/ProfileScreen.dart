...
class _ProfileScreenState extends State<ProfileScreen> {
  String _url = 'https://sectest.net/privacy-notice/';
  String url = 'https://sectest.net/terms-of-use/';
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          profileData['profile_pic'] == null || profileData['profile_pic'] == 'null' || profileData['profile_pic'] == ''
                              ? string == 3
                                  ? Container(
                                      height: height * 0.1,
                                      width: width * 0.25,
                                  ...
                                  : Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(image: AssetImage('assets/images/profile-1.jpg'), fit: BoxFit.cover), borderRadius: BorderRadius.circular(10)),
                                    )
                              : string == 3
                                  ? Container(
                                      height: height * 0.1,
                          ...
                          Column(
                            ...
                            children: [
                              profileData['is_business_profile'] == 0
                                  ? Container()
                                  : Row(
                                      children: [
                              ...
                              AppText1(profileData['user_name'] ?? '', fontSize: 16, color: Colors.black),
                              AppText(profileData['email'] ?? '', fontSize: 15, color: Colors.black)
                            ],
                          )
                        ],
                      ),
                    ...
                    SizedBox(height: height * 0.004),
                    Align(alignment: Alignment.centerLeft, child: AppText1('Legal', color: Colors.black)),
                    SizedBox(height: height * 0.004),
                    DetailsWidget(
